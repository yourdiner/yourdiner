...
export function DayInRestaurantSection() {
  ...
  return (
    <section id="story" className="bg-[#fafafa] py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 lg:mt-14 lg:grid-cols-[minmax(0,260px)_1fr] lg:gap-12">
            ...
            {DAY_PHASES.map((item, i) => (
              <button
                ...
                className={cn(
                  ...
                  active === i
                    ? "bg-zinc-950 text-zinc-50 shadow-[0_12px_32px_-12px_rgba(24,24,27,0.35)]"
          ...
          <div className="rounded-[1.25rem] bg-zinc-950/[0.03] p-1 ring-1 ring-zinc-950/[0.06] sm:rounded-[1.5rem] sm:p-1.5">
            <div className="min-h-[280px] rounded-[calc(1.25rem-0.25rem)] bg-white p-6 sm:min-h-[320px] sm:rounded-[calc(1.5rem-0.375rem)] sm:p-8 lg:min-h-[360px] lg:p-10">
              <AnimatePresence mode="wait">
                ...
                >
                  <p className="text-sm font-semibold text-sky-600">{phase.time}</p>
                  <h3 className="mt-2 text-xl font-semibold tracking-tight text-zinc-950 sm:mt-3 sm:text-3xl">
                    {phase.title}
                  </h3>
                  <ul className="mt-6 space-y-4 sm:mt-8 sm:space-y-5">
                    {phase.beats.map((beat, i) => (
                      ...
                      >
                        <span className="mt-2.5 h-px w-6 shrink-0 bg-sky-400 sm:w-8" />
                        <span className="text-[15px] leading-relaxed text-zinc-600 sm:text-base">
                          {beat}
                        </span>
                      </motion.li>
                    ))}
